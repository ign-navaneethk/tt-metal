...
class PanopticDeeplabRes3Res2Model(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.res3 = PanopticDeeplabDecoderRes3Model()
        self.res2 = PanopticDeeplabDecoderRes2Model()
...
class PanopticDeeplabASPPRes3Res2Model(torch.nn.Module):
    def __init__(self):
        super().__init__()
...
class PanopticDeeplabASPPRes3Res2HeadModel(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.aspp = PanopticDeeplabASPPModel()
        self.res3 = PanopticDeeplabDecoderRes3Model()
        self.res2 = PanopticDeeplabDecoderRes2Model()
        self.head = PanopticDeeplabHeadModel()
