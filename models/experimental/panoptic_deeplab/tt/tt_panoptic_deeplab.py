...
class TTPanopticDeepLab:
    ...
    def __call__(
        ...
        backbone_features = ttnn.reallocate(backbone_features)  # ADD THIS

        # Convert to expected memory config if needed
        # if backbone_features.memory_config() != ttnn.L1_MEMORY_CONFIG:
        #     backbone_features = ttnn.to_memory_config(
        #     backbone_features, ttnn.L1_MEMORY_CONFIG
        # )
